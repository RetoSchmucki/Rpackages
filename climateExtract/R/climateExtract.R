...
#' temporal_mean
#' 
#' This function compute mean climatic value for specific periods "annual", "monthly", or using a sliding window "window" of specific length, from and object obtained from the extrat_nc_value() function
